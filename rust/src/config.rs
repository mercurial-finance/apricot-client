...
pub fn get_pool_id_by_token_mint(token_mint: Pubkey) -> u8 {
    match token_mint {
        ...
        btc::ID => btc::POOL_ID,
        eth::ID => eth::POOL_ID,
        wheth::ID => wheth::POOL_ID,
        sol::ID => sol::POOL_ID,
        msol::ID => msol::POOL_ID,
        stsol::ID => stsol::POOL_ID,
        scnsol::ID => scnsol::POOL_ID,
        ray::ID => ray::POOL_ID,
        orca::ID => orca::POOL_ID,
        srm::ID => srm::POOL_ID,
        usdt::ID => usdt::POOL_ID,
        usdc::ID => usdc::POOL_ID,
        ust::ID => ust::POOL_ID,
        usdt_usdc_saber::ID => usdt_usdc_saber::POOL_ID,
        msol_sol_saber::ID => msol_sol_saber::POOL_ID,
        stsol_sol_saber::ID => stsol_sol_saber::POOL_ID,
        ust_usdc_saber::ID => ust_usdc_saber::POOL_ID,
        usdc_usdt_orca::ID => usdc_usdt_orca::POOL_ID,
        sol_usdc_orca::ID => sol_usdc_orca::POOL_ID,
        msol_sol_orca::ID => msol_sol_orca::POOL_ID,
        orca_usdc_orca::ID => orca_usdc_orca::POOL_ID,
        orca_sol_orca::ID => orca_sol_orca::POOL_ID,
        eth_usdc_orca::ID => eth_usdc_orca::POOL_ID,
        sol_usdt_orca::ID => sol_usdt_orca::POOL_ID,
        eth_sol_orca::ID => eth_sol_orca::POOL_ID,
        apt_usdc_orca::ID => apt_usdc_orca::POOL_ID,
        btc_msol_orca::ID => btc_msol_orca::POOL_ID,
        msol_usdc_orca::ID => msol_usdc_orca::POOL_ID,
        stsol_ust_orca::ID => stsol_ust_orca::POOL_ID,
        orca_wheth_orca::ID => orca_wheth_orca::POOL_ID,
        sol_usdc_raydium::ID => sol_usdc_raydium::POOL_ID,
        ray_usdc_raydium::ID => ray_usdc_raydium::POOL_ID,
        sol_usdt_raydium::ID => sol_usdt_raydium::POOL_ID,
        msol_sol_raydium::ID => msol_sol_raydium::POOL_ID,
        ray_usdt_raydium::ID => ray_usdt_raydium::POOL_ID,
        ray_eth_raydium::ID => ray_eth_raydium::POOL_ID,
        ray_sol_raydium::ID => ray_sol_raydium::POOL_ID,
        srm_usdc_raydium::ID => srm_usdc_raydium::POOL_ID,
        _ => panic!("Token doens't have a pool!"),
    }
}
